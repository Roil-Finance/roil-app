  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div className="grid grid-cols-2 gap-6 mt-7 flex-1 min-h-0">
        {/* LEFT — Ready Strategy */}
        <div className="bg-[#F3F4F9] dark:bg-slate-800 border border-[#D6D9E3] dark:border-slate-700 rounded-2xl p-8 flex flex-col items-center justify-center text-center">
          <img
          ...
          <h2 className="text-[28px] font-bold text-[#111827] dark:text-slate-100 mb-2">
            Use a Ready Strategy
          </h2>
          <p className="text-[15px] text-[#6B7280] dark:text-slate-400 mb-5 max-w-[340px]">
        ...
        <div className="bg-[#F3F4F9] dark:bg-slate-800 border border-[#D6D9E3] dark:border-slate-700 rounded-2xl p-8 flex flex-col items-center justify-center text-center">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-7 py-3 rounded-xl font-semibold text-[15px]
                       border-2 border-[#D6D9E3] dark:border-slate-700 text-[#111827] dark:text-slate-100 hover:border-[#9CA3AF] transition-colors bg-white dark:bg-slate-800"
          >
            Start from Scratch
          </Link>
        </div>
